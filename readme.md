# This gulp plugin is based on [gulp-hihlight](http://github.com/johannestroeger/gulp-highlight) and it is modified to allow for manual language configuration.
